...
let universeupgrd;
let universeupgrdinfo = [false, 0, 9000000000000000, 730, 1280, 250, 75];
...
//Overlay when you can't buy anything
let overlay;
let buyoverlay = [];
let multioverlay;
let multibuyoverlay = [];

//Info when hovering over something
let info = " ";
let subinfo = " ";
let owned = " ";
...
function preload() {
  ...
  universeupgrd = loadImage("Universe.png");
...
function setup() {
  let canvas = createCanvas(1126, 675);
  noStroke();
  textAlign(CENTER);
  textFont(font);
  frameRate(60);
...
function draw() {
  ...
  textSize(40);
  fill(100);
  text(short(rockets) + " " + windowHeight, 150, 120, 1);
  textSize(20);
  fill(70);
  ...
  image(
    modelrocketupgrd,
    modelrocketupgrdinfo[3],
    scroll + 20,
    modelrocketupgrdinfo[5],
    modelrocketupgrdinfo[6]
  );
  textSize(20);
  fill(200);
  ...
  textSize(20);
  fill(200);
  text(short(starshipupgrdinfo[2]), 930, scroll + 435);
  ...
  image(
    tardigradeupgrd,
    tardigradeupgrdinfo[3],
    scroll + 740,
    tardigradeupgrdinfo[5],
    tardigradeupgrdinfo[6]
  );
  textSize(20);
  fill(200);
  ...
  textSize(20);
  fill(200);
  text(short(universeupgrdinfo[2]), 930, scroll + 1425);
  if (rockets < universeupgrdinfo[2]) {
    image(
      overlay,
      universeupgrdinfo[3],
      scroll + 1370,
  ...
  if (
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 95 * scalen &&
    mouseY > scroll + 20 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 185 * scalen &&
    mouseY > scroll + 110 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 275 * scalen &&
    mouseY > scroll + 200 * scalen
  ) {
    info = "Higher rockets";
    subinfo = "+5 rps!";
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 365 * scalen &&
    mouseY > scroll + 290 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 455 * scalen &&
    mouseY > scroll + 380 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 545 * scalen &&
    mouseY > scroll + 470 * scalen
  ) {
    info = "Compact fuel";
    subinfo = "+1.2k rps!";
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 635 * scalen &&
    mouseY > scroll + 560 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 725 * scalen &&
    mouseY > scroll + 650 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 815 * scalen &&
    mouseY > scroll + 740 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 905 * scalen &&
    mouseY > scroll + 830 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 995 * scalen &&
    mouseY > scroll + 920 * scalen
  ) {
    info = "2, 4, 6, 8, 16, 32...";
    subinfo = "+10m rps";
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 1085 * scalen &&
    mouseY > scroll + 1010 * scalen
  ) {
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 1175 * scalen &&
    mouseY > scroll + 1100 * scalen
  ) {
    info = "Folding space";
    subinfo = "+145m rps";
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 1265 * scalen &&
    mouseY > scroll + 1190 * scalen
  ) {
    info = "It's alive!";
    subinfo = "+750m rps";
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 1355 * scalen &&
    mouseY > scroll + 1280 * scalen
  ) {
    info = "!sonamuh aloH¡";
    subinfo = "+3b rps";
    ...
    mouseX < 980 * scalen &&
    mouseX > 730 * scalen &&
    mouseY < scroll + 1445 * scalen &&
    mouseY > scroll + 1360 * scalen
  ) {
    info = "The whole frickin universe";
    subinfo = "+??? rps";
    owned = "owned: " + universeupgrdinfo[1];
  } else {
    info = " ";
    subinfo = " ";
    owned = " ";
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 500 * scalen &&
    mouseY > pscroll + 200 * scalen &&
    mouseY > 120 * scalen
  ) {
    info = "Mars";
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 900 * scalen &&
    mouseY > pscroll + 600 * scalen &&
    mouseY > 120 * scalen
  ) {
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 1300 * scalen &&
    mouseY > pscroll + 1000 * scalen &&
    mouseY > 120 * scalen
  ) {
    info = "TOI 700 b";
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 1700 * scalen &&
    mouseY > pscroll + 1400 * scalen &&
    mouseY > 120 * scalen
  ) {
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 2100 * scalen &&
    mouseY > pscroll + 1800 * scalen &&
    mouseY > 120 * scalen
  ) {
    info = "CoRoT-7b";
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 2500 * scalen &&
    mouseY > pscroll + 2200 * scalen &&
    mouseY > 120 * scalen
  ) {
    info = "Kepler-22b";
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 2900 * scalen &&
    mouseY > pscroll + 2600 * scalen &&
    mouseY > 120 * scalen
  ) {
    info = "TrES-4b";
  ...
  if (
    mouseX < 660 * scalen &&
    mouseX > 360 * scalen &&
    mouseY < pscroll + 3300 * scalen &&
    mouseY > pscroll + 3000 * scalen &&
    mouseY > 120 * scalen
  ) {
    info = "Kepler-69c";
...
function mouseClicked() {
  ...
  //Upgrades
  if (mouseX < 220 * scalen && mouseX > 70 * scalen && mouseY < 450 * scalen && mouseY > 250 * scalen) {
    clickfx.play();
    ...
    mouseX > 730 * scalen &&
    mouseY < scroll + 1445 * scalen &&
    mouseY > scroll + 1170 * scalen
  ) {
    if (rockets >= universeupgrdinfo[2]) {
      clickfx.play();
      universeupgrdinfo[0] = true;
      universeupgrdinfo[1]++;
      rockets -= universeupgrdinfo[2];
      universeupgrdinfo[2] *= 1.5;
      universeupgrdinfo[2] = Math.ceil(universeupgrdinfo[2]);
      rps += 22000000000;
    }
  }
}
...
function mouseWheel(event) {
  if (mouseX < width && mouseX > 720 * scalen && mouseY < height && mouseY > 0) {
  ...
  if (mouseX < 700 * scalen && mouseX > 320 * scalen && mouseY < height && mouseY > 120 * scalen) {
...
function short(num) {
  if (num > 999999 && num < 1000000000) {
    return (
      Math.floor(num / 1000000) + "." + (Math.floor(num / 1000) % 1000) + "m"
    );
    ...
    return (
      ...
      "." +
      (Math.floor(num / 1000000000) % 1000) +
      "t"
    );
    ...
    return (
      ...
      "." +
      (Math.floor(num / 1000000000000) % 1000) +
      "qd"
    );
  } else {
    return num;
