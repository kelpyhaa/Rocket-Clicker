...
function draw() {
  ...
  textSize(40);
  fill(100);
  text(short(rockets) + mouseX + ", " + mouseY, 150, 120, 1);
  textSize(20);
  fill(70);
  ...
  if (
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 95 * 1.125 &&
    mouseY > scroll + 20 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 185 * 1.125 &&
    mouseY > scroll + 110 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 275 * 1.125 &&
    mouseY > scroll + 200 * 1.125
  ) {
    info = "Higher rockets";
    subinfo = "+5 rps!";
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 365 * 1.125 &&
    mouseY > scroll + 290 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 455 * 1.125 &&
    mouseY > scroll + 380 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 545 * 1.125 &&
    mouseY > scroll + 470 * 1.125
  ) {
    info = "Compact fuel";
    subinfo = "+1.2k rps!";
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 635 * 1.125 &&
    mouseY > scroll + 560 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 725 * 1.125 &&
    mouseY > scroll + 650 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 815 * 1.125 &&
    mouseY > scroll + 740 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 905 * 1.125 &&
    mouseY > scroll + 830 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 995 * 1.125 &&
    mouseY > scroll + 920 * 1.125
  ) {
    info = "2, 4, 6, 8, 16, 32...";
    subinfo = "+10m rps";
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 1085 * 1.125 &&
    mouseY > scroll + 1010 * 1.125
  ) {
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 1175 * 1.125 &&
    mouseY > scroll + 1100 * 1.125
  ) {
    info = "Folding space";
    subinfo = "+145m rps";
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 1265 * 1.125 &&
    mouseY > scroll + 1190 * 1.125
  ) {
    info = "It's alive!";
    subinfo = "+750m rps";
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 1355 * 1.125 &&
    mouseY > scroll + 1280 * 1.125
  ) {
    info = "!sonamuh aloH¡";
    subinfo = "+3b rps";
    ...
    mouseX < 980 * 1.125 &&
    mouseX > 730 * 1.125 &&
    mouseY < scroll + 1445 * 1.125 &&
    mouseY > scroll + 1360 * 1.125
  ) {
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 500 * 1.125 &&
    mouseY > pscroll + 200 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
    info = "Mars";
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 900 * 1.125 &&
    mouseY > pscroll + 600 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 1300 * 1.125 &&
    mouseY > pscroll + 1000 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
    info = "TOI 700 b";
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 1700 * 1.125 &&
    mouseY > pscroll + 1400 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 2100 * 1.125 &&
    mouseY > pscroll + 1800 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
    info = "CoRoT-7b";
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 2500 * 1.125 &&
    mouseY > pscroll + 2200 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
    info = "Kepler-22b";
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 2900 * 1.125 &&
    mouseY > pscroll + 2600 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
    info = "TrES-4b";
  ...
  if (
    mouseX < 660 * 1.125 &&
    mouseX > 360 * 1.125 &&
    mouseY < pscroll + 3300 * 1.125 &&
    mouseY > pscroll + 3000 * 1.125 &&
    mouseY > 120 * 1.125
  ) {
    info = "Kepler-69c";
...
function mouseClicked() {
  ...
  //Upgrades
  if (mouseX < 220 * 1.125 && mouseX > 70 * 1.125 && mouseY < 450 * 1.125 && mouseY > 250 * 1.125) {
    clickfx.play();
...
function mouseWheel(event) {
  if (mouseX < width && mouseX > 720 * 1.125 && mouseY < height && mouseY > 0) {
  ...
  if (mouseX < 700 * 1.125 && mouseX > 320 * 1.125 && mouseY < height && mouseY > 120 * 1.125) {
